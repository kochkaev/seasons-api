...
public class Config {
    ...
    public static void init__() {
        ...
        jsonCore = JSONConfigCore.openOrCreate("Seasons4Fabric/config");
...
class DefaultTXTConfig {
    ...
    private static void generate() {
        ...
        gen.addValueAndCommentDefault("lang.season.winter.name", "&2Весна");
        gen.addValueAndCommentDefault("lang.season.winter.message", "&eС глаз долой весь снег! Наступила %season%");
        // Summer
        gen.addComment(" Summer");
        gen.addValueAndCommentDefault("lang.season.winter.name", "&aЛето");
        gen.addValueAndCommentDefault("lang.season.winter.message", "&eНастало время пекла! Наступило %season%");
        // Fall
        gen.addComment(" Fall");
        gen.addValueAndCommentDefault("lang.season.winter.name", "&6Осень");
        gen.addValueAndCommentDefault("lang.season.winter.message", "&eУнылая пора! Очей очарованье! Наступила %season%");
